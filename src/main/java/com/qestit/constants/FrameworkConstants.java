...
public final class FrameworkConstants {
    ...
    public static final String JIRA_PASSWORD = PropertiesHelpers.getValue("JIRA_PASSWORD");
    public static final String JIRA_CREATION_ISSUE = PropertiesHelpers.getValue("JIRA_CREATION_ISSUE");

    public static final String BROWSER = PropertiesHelpers.getValue("BROWSER");
    public static final String URL_ECOMMERCE = PropertiesHelpers.getValue("URL_ECOMMERCE");
    ...
    public static final String SEND_NOTIFICATION_TO_SLACK_CHANNEL = PropertiesHelpers.getValue("SEND_NOTIFICATION_TO_SLACK_CHANNEL");
    public static final String WEBHOOK_URL = PropertiesHelpers.getValue("WEBHOOK_URL");
    ...
    public static final String ICON_SOCIAL_GITHUB_PAGE_URL = "https://qestit.com/";
    public static final String ICON_SOCIAL_LINKEDIN_URL = "https://www.linkedin.com/in/qestit/";
    public static final String ICON_SOCIAL_GITHUB_URL = "https://github.com/qestit";
