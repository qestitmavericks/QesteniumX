...
/**
 * Usage Scenarios:
 * Use readJsonFile for operations requiring the full JSON content.
 * Use setJsonFile to prepare for querying JSON data from a specific file.
 * Use getJsonDataSourceString as a utility method to ensure JSON data is always available for querying,
 * especially in cases where the JSON file to be used is the default one.
 */
public class JsonUtils {
    ...
    //The primary goal of this method is to retrieve specific data from the JSON structure 
