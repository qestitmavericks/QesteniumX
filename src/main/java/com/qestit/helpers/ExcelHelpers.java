...
public class ExcelHelpers {
    ...
    public void setExcelFile(String excelPath, String sheetName) {
        ...
        try {
            ...
            updateColumnHeaders(); // Update the column headers here
            if (sheet == null) {
    ...
    // If the Excel file's structure (like its columns) can change during runtime,
    // This Method ensure that the columns map is updated accordingly. 
    // This might involve re-reading the first row of the sheet to refresh the columns map.
